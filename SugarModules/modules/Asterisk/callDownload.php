...
if (is_numeric($_GET['id'])) {
	...
	$found = false;
    $files_wav = glob($sugar_config['asterisk_recordings_path'] . '/*' . $callID . '.wav');
	$files_mp3 = glob($sugar_config['asterisk_recordings_path'] . '/*' . $callID . '.mp3');
